...
PYBIND11_MODULE(_structural, m) {
  ...
  py::class_<StructuralInterpolant>(m, "StructuralInterpolant3")
      .def(py::init<const Model<3>&, double, double, double, bool>(),
           "base_model"_a,
           "outside_value"_a = -1.0,
           "blend_power"_a = 1.0,
           "alignment_strength"_a = 0.0,
           "background_blending"_a = false)
      ...
      .def_property_readonly("background_blending",
                             &StructuralInterpolant::background_blending)
